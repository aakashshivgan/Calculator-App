...
private Button button0,button1,button2,button3,button4,button5,button6,button7,button8,button9,buttonPercent,
    buttonAdd,buttonSub,buttonDiv,buttonMulti,buttonPoint,buttonPower,buttonClear,buttonEqual;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMulti=findViewById(R.id.multiply_btn);
